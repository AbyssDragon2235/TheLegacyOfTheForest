...
public class DayNightScript : MonoBehaviour
{
    ...
    public static DayNightScript instance;
    ...
    void Start()
    {
        //dayTimeContainer = GameObject.FindGameObjectWithTag("TimeDisplay");
        //timeDisplay = dayTimeContainer.GetComponentInChildren(TimeDisplay);
